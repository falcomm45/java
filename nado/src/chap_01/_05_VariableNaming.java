...
public class _05_VariableNaming {
    public static void main(String[] args) {
        ...
        // 6. 예약어는 사용 불가 (public static, void, int, float, double, ...)

        // 입국 신고서 (여행)
        String nationality = "대한민국"; // 국적
        String firstName = "형택"; // 이름
        String lestName = "임"; // 성
        String dateOfBirth = "1993-02-15"; // 생년월일
        String residentialAddress = "용봉뉴타운"; // 체류지
        String purposeOfVisit = "관광"; // 입국목적
        String flightNo = "KE657"; // 항공편
        String _flightNo = "KE657"; // 밑줄 시작
        String flight_no_2 = "KE657"; // 밑줄과 시작
